...
public class FrontController {
	...
	public String login_submit(@RequestParam(value="userid") String userid, @RequestParam(value="pwd") String pwd, HttpSession session) {
...
//		fs.close();   
	...
	@RequestMapping(value="/MemberEditOk.do")
		public String memberEdit_submit(Emp emp) {
