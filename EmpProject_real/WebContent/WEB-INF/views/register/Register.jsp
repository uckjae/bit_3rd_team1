                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-6">
                                                    <div class="form-label-group">
												        <input type="text" id="empno" name="empno"  class="form-control" placeholder="Empno" >
                                            ...
                                            <div class="form-group">
                                                <div class="form-row">
                                                    <div class="col-md-6">
                                                        <div class="form-label-group">
                                                        <input type="text" name="hiredate" class="form-control" placeholder="Hire Date" required="required">
<!--                                                             <input type="date" id="hiredate" name="hiredate" class="form-control" placeholder="Hire Date" required="required">
 -->	                                                        <label for="hiredate">Hire Date</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-label-group">
                                                        <!-- Job -->
                                                     		<input type="text" name="job" class="form-control" placeholder="job" required="required">
                                            ...
                                            <div class="form-group">
                                                <div class="form-row">
                                                    <div class="col-md-6">
                                                        <div class="form-label-group">
                                                        <input type="text" name="deptno" class="form-control" placeholder="deptno" required="required">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-label-group">
                                                        <input type="text" name="mgr" class="form-control" placeholder="mgr" required="required">
